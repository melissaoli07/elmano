                            ...
                            for message in change["value"]["messages"]:
                                ...
                                if "button" in message:
                                    ...
                                    if button_payload:
                                        ...
                                        save_message_to_firestore(event_id, sender_id, "received", recipient_id, message_text, button_payload, evento=None, data=data, inicio=None, termino=None, local=None)
